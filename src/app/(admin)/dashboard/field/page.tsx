...
export default async function FieldManagement() {
  const options = ['Edit detail lapangan', 'Lihat riwayat penggunaan'];
    return (
        <div>
         ...
         <div className="grid m-20 gap-10">
          <div className="flex inline-flex justify-between">
           <h1>Data Lapangan</h1>
           <button className={'h-[30px] self-end inline-flex items-center gap-[10px] px-[10px] py-[5px] relative bg-[#ffffff] hover:bg-slate-100 rounded-[6px] shadow-[0px_2px_4px_#1e293b40]'}>
