...
export default function FieldDetail({
  ...
  const [scheduleData, setScheduleData] = useState<ScheduleData>({ orderDate: '', hourRange: 0 });
  ...
  const handleBookButtonClicked = async ({FieldID, CustomerID, CustomerName, HourRange, TotalPrice, orderDate
  }: {
    FieldID: string;
    CustomerID: string;
    CustomerName: string;
