...
export const Reservation = (lapangan : Props): JSX.Element => {
    ...
    useEffect(() => {
      ...
      const todaySlot = lapangan.lapangan.datePlots.find(slot => slot.date.setHours(0, 0, 0, 0) === todayDate);
    ...
    const handleDayClick: DayClickEventHandler = (day, modifiers, e) => {
        if (modifiers.selected) {
          ...
          const selectedSlot = lapangan.lapangan.datePlots.find(slot => slot.date.getTime() === day.getTime());
